...
class ObsoleteHQSmokeTests(TestCase):
    ...
    def test_seed_creates_basic_part_pages_with_assets_and_resources(self):
        ...
        expected = {
            ...
            "dht11-humiture-sensor": (5, 6),
            "mpu6050-module": (4, 4),
            "laser-transmitter-module": (3, 2),
            "infrared-transmitter-module": (2, 2),
            "infrared-obstacle-avoidance-sensor": (3, 2),
            "heartbeat-sensor-module": (4, 2),
            "high-sensitivity-microphone-sensor": (4, 2),
            "metal-touch-sensor": (4, 2),
            "flame-sensor-module": (4, 2),
            "line-tracking-sensor-module": (4, 2),
            "linear-hall-sensor-module": (4, 2),
            "rotary-encoder-module": (4, 2),
            "magic-light-cup-module": (4, 2),
            "digital-temperature-sensor-module": (4, 2),
            "light-blocking-sensor-module": (4, 2),
            "ds18b20-temperature-sensor-module": (4, 3),
            "two-color-led-module": (8, 4),
            "mercury-tilt-switch-module": (4, 2),
            "hall-magnetic-sensor-module": (4, 2),
            "vibration-switch-module": (4, 2),
            "knock-sensor-module": (4, 2),
            "analog-hall-magnetic-sensor-module": (4, 2),
            "microphone-sound-sensor-module": (4, 2),
        }
        sensor_kit_coverage = {
